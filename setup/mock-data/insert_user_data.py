...
def insert_users(db: Session):
    ...
    users_data = [
        ...
        },
        {
            ...
            "user_profile": "/public/user-profile/photo-1506794778202-cad84cf45f1d.jpeg",
            "is_active": True,
        ...
        },
        {
            ...
            "email": "sooryanarayanan@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Diana Miller",
            "role_id": "role_project_manager",
            "user_profile": "/public/user-profile/photo-1558222218-b7b54eede3f3.jpeg",
            "is_active": True,
        ...
        },
        {
            ...
            "email": "dhanasekar@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Dhana Sekar",
            "role_id": "role_project_manager",
            "user_profile": "/public/user-profile/photo-1560250097-0b93528c311a.jpeg",
            "is_active": True,
        ...
        },
         {
            ...
            "email": "vidya@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Vidya S",
            "role_id": "role_project_manager",
            "user_profile": "/public/user-profile/photo-1493666438817-866a91353ca9.jpeg",
            "is_active": True,
        ...
        },
        {
            ...
            "email": "hariganesh@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Hari Ganesh",
            "role_id": "role_developer",
            "user_profile": "/public/user-profile/photo-1500648767791-00dcc994a43e.jpeg",
            "is_active": True,
            "last_login": datetime.now() - timedelta(hours=3),
        ...
        },
        {
            ...
            "name": "Aarya strak",
            "role_id": "role_tester",
            "user_profile": "/public/user-profile/photo-1438761681033-6461ffad8d80.jpeg",
            "is_active": True,
        ...
        },
        {
            ...
            "email": "thanseer@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Mohammed Thanseer",
            "role_id": "role_developer",
            "user_profile": "/public/user-profile/photo-1519345182560-3f2917c472ef.jpeg",
            "is_active": True,
        ...
        },
        {
            ...
            "email": "natasha@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Natasha Stev",
            "role_id": "role_developer",
            "user_profile": "/public/user-profile/photo-1487412720507-e7ab37603c6f.jpeg",
            "is_active": True,
        ...
        },        
        {
            ...
            "email": "Vignesh@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Vignesh Kumar",
            "role_id": "role_developer",
            "user_profile": "/public/user-profile/photo-1507591064344-4c6ce005b128.jpeg",
            "is_active": True,
        ...
        },
        {
            ...
            "email": "karthick@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Karthick Raja",
            "role_id": "role_developer",
            "user_profile": "/public/user-profile/photo-1537511446984-935f663eb1f4.jpeg",
            "is_active": True,
        ...
        },        
        {
            ...
            "name": "David Thompson",
            "role_id": "role_developer",
            "user_profile": "/public/user-profile/default.png",
            "is_active": True,
            "last_login": datetime.now() - timedelta(hours=5),
            "department": "Engineering",
            "skills": ["C#", ".NET", "Azure"],
        ...
        },
        {
            ...
            "email": "vendhanth@planora.com",
            "password": get_password_hash("planora@123"),
            "name": "Vendhanth Kumar",
            "role_id": "role_tester",
            "user_profile": "",
            "is_active": True,
            "last_login": datetime.now() - timedelta(hours=12),
...
def create_user_tables_and_insert_data():
    ...
    try:
        ...
        print("   • All others: [email] / planora@123")
